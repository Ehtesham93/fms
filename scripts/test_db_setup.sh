...
export SEED_DB="true"
export TARGETSCHEMA="stgfmscoresch"

# Database credentials from dev_config.js
#PGHOST="rds-nemo-stage.c55qjjjzouym.ap-south-1.rds.amazonaws.com"
#PGPORT="5432"
PGHOST="mahindra-tunnel.intellicar.io"
PGPORT="22041"
PGDB="lmmintellicar"
PGUSER="lmmintellicar_admin"
PGPASSWORD="Z52DWfsAZIBtnOK"

# Target database and schema for seedfmscoresch
TARGETDB="lmmintellicar"
TARGETUSERNAME="lmmintellicar_admin"
TARGETPASSWORD="Z52DWfsAZIBtnOK"
...
node ./scripts/db_init.js $PGHOST $PGPORT $PGDB $PGUSER $PGPASSWORD $TARGETDB $TARGETSCHEMA $TARGETUSERNAME $TARGETPASSWORD
...
PGPASSWORD=$TARGETPASSWORD PGOPTIONS="--search_path=$TARGETSCHEMA,public" psql -p$PGPORT -U$TARGETUSERNAME -h $PGHOST $TARGETDB < scripts/db_create.psql
